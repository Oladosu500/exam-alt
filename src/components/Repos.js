  ...
  return <> {user.map(user => (
      <div className="container">
                ...
                <article className="item-art">
                    ...
                    <p>{user.name}</p>
                    {user.private ? <p className="red">Private</p> : <p className="green">Public</p>}
                </article>
        
                <div className="item-repo">
                  <p>this repository was created at {" "} {format (new Date(user.created_at), "dd MMMM yyyy" )} by{" "}{user.owner.login } </p>  
                
                
                    <p><a href={user.html_url} target="_blank" rel="noreferrer noopener">View Repo</a></p>
